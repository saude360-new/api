...
public class DeviceDataController {
  ...
  @GetMapping("/by-device/{deviceId}/bpm")
  public ResponseEntity<String> getByDeviceIdBpm(@PathVariable String deviceId) {
    logger.debug("Recebida requisição para buscar dados de BPM do dispositivo: {}", deviceId);

    checkDeviceID(deviceId);

    String dado = deviceDataService.findBpmGraphByDeviceId(deviceId);
    if (dado == null)
      dado = "[]";
